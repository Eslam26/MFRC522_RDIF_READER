...
/*----------------------------------------------------------------------------------------------------
 [Function Name]:  MFRC522_getCardSerial
 [Description]  :  This function is responsible for getting card serial
 [Args]
 [In]           :  uint8 * a_serialOut
 	 	 	 	 	 This arg shall indicates the address of the array that contains the serial Number
				   uint16 waitingResponseTime
				     This arg shall indicates the waiting time respone befores time out occurs
 [Returns]      :  This function returns status of the operation
 ----------------------------------------------------------------------------------------------------*/
